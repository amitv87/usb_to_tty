...
#ifdef USE_CSR
REG_DEV(CSR8510, 0x0a12, 0x0001,
  REG_HCI_IFACE(hci0, 0x00, 0x00, 0x81, 0x02, 0x82)
)
#endif

#ifdef USE_TPLINK
REG_DEV(UB500, 0x2357, 0x0604,
  REG_HCI_IFACE(hci0, 0x00, 0x00, 0x81, 0x02, 0x82)
)
#endif

REG_DEV(efm8, 0x10c4, 0x8253,
  REG_CDC_IFACE(cmd, 0x00, 0x01, 0x81)
)
...
REG_DEV(cp210x, 0x10c4, 0xea70,
  ...
  REG_CDC_IFACE(diag2, 0x05, 0x0e, 0x85)
  */
  REG_CDC_IFACE(uart1, 0x00, 0x01, 0x81)
  REG_CDC_IFACE(uart2, 0x01, 0x02, 0x82)
)
